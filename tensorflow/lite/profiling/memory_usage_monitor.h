...
class MemoryUsageMonitor {
 public:
  ...
  static constexpr int64_t kInvalidMemUsageMB = -1024 * 1024;
 ...
 private:
  ...
  int64_t peak_mem_footprint_bytes_ = kInvalidMemUsageMB;
  int64_t peak_in_use_mem_bytes_ = kInvalidMemUsageMB;
};
