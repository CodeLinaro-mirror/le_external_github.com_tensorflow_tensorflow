...
static PyObject* is_traceme_enabled_raw(PyObject* self, PyObject* args) {
  if (xla::profiler::GetTraceMeEnabledSingleton()) {
    Py_RETURN_TRUE;
  }
  Py_RETURN_FALSE;
}

static PyMethodDef traceme_method_def = {"is_traceme_enabled_raw",
                                         is_traceme_enabled_raw, METH_NOARGS,
                                         "Returns true if TraceMe is enabled."};
