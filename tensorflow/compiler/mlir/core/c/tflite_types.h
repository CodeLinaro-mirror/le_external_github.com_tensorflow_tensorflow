...
#ifndef TENSORFLOW_COMPILER_MLIR_CORE_C_TFLITE_TYPES_H_
#define TENSORFLOW_COMPILER_MLIR_CORE_C_TFLITE_TYPES_H_
...
#endif  // TENSORFLOW_COMPILER_MLIR_CORE_C_TFLITE_TYPES_H_
