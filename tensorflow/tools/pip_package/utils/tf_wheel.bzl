...
def _tf_wheel_impl(ctx):
    ...
    check_wheel_compliance = ctx.attr.verify_manylinux_compliance[BuildSettingInfo].value
...
tf_wheel = rule(
    attrs = {
        ...
        "verify_manylinux_compliance": attr.label(default = Label("@local_tsl//third_party/py:verify_manylinux")),
