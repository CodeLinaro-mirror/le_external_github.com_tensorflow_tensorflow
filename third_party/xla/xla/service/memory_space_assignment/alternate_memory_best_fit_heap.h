...
#ifndef XLA_SERVICE_MEMORY_SPACE_ASSIGNMENT_ALTERNATE_MEMORY_BEST_FIT_HEAP_H_
#define XLA_SERVICE_MEMORY_SPACE_ASSIGNMENT_ALTERNATE_MEMORY_BEST_FIT_HEAP_H_
...
#endif  // XLA_SERVICE_MEMORY_SPACE_ASSIGNMENT_ALTERNATE_MEMORY_BEST_FIT_HEAP_H_
