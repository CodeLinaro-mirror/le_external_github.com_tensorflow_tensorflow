...
fused_computation.4150.clone {
  ...
  constant.230138 = s32[]{:T(128)} constant(0)
  param_1.219146 = s32[]{:T(128)S(6)} parameter(1)
  ROOT dynamic-update-slice.40526 = s8[2,6144,2,256]{3,1,0,2:T(8,128)(4,1)} dynamic-update-slice(fusion.103344, param_1.185389, constant.230138, constant.230138, param_1.219146, constant.230138)
}
...
fused_computation.4150.clone {
  ...
  constant.230138 = s32[]{:T(128)} constant(0)
  param_1.219146 = s32[]{:T(128)S(6)} parameter(1)
  ROOT dynamic-update-slice.40526 = s8[2,6144,2,256]{3,1,0,2:T(8,128)(4,1)} dynamic-update-slice(param_0.185389, param_1.185389, constant.230138, constant.230138, param_1.219146, constant.230138)
}
