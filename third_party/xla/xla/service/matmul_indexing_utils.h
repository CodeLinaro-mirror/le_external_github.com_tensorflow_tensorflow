...
class DotOperandDims {
 public:
  ...
  // Merges adjacent dimensions of the same category.
  ...
  // instruction) to the operand of the instruction. Supports kTranspose,
  // kReshape, and kBitcast. Returns std::nullopt if category mixing occurs
  // during reshape/bitcast.
  ...
  // instruction) to the output of the instruction. Supports kTranspose,
  // kReshape, and kBitcast. Returns std::nullopt if category mixing occurs
  // during reshape/bitcast.
