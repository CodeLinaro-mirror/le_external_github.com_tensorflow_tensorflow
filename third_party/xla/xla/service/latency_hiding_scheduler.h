...
class SchedulerCore {
 public:
  ...
  virtual absl::Status CaptureScheduleProto() {
    return absl::UnimplementedError(
        "This SchedulerCore does not implement capturing schedule proto.");
  }

  virtual absl::StatusOr<ScheduleProto> GetCapturedScheduleProto() {
    return absl::UnimplementedError(
        "This SchedulerCore does not implement capturing schedule proto");
  }
