...
FusionDecision CpuInstructionFusion::ShouldFuse(HloInstruction* consumer,
  ...
  if (producer->opcode() != HloOpcode::kFusion && is_expensive(*producer) &&
    ...
    return FusionDecision::Deny("Fusion is not profitable.");
  }
  ...
  if (producer->opcode() == HloOpcode::kConstant &&
    ...
    return FusionDecision::Deny("Not fusing: insufficient non-constant nodes.");
  }
  ...
  if (consumer->opcode() == HloOpcode::kFusion) {
    ...
    if (fusion_node_evaluations_.at(consumer).CodeDuplicationTooHigh(
            producer)) {
      return FusionDecision::Deny("Code duplication too high");
    }
  }
  ...
  if (consumer->opcode() == HloOpcode::kReduce &&
    ...
    return FusionDecision::Deny("Not fusing reductions over major dimensions");
  }
  ...
  return FusionDecision::Deny("Not fusing: not found a fusible case");
}
