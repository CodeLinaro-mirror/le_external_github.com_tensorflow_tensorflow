...
load("//xla/backends/gpu/target_config:target_configs.bzl", "target_configs")
...
def xla_aot_compile_gpu(
    ...
    for target in gpu_targets:
        ...
        native.genrule(
            ...
            srcs = [module, target_configs[target], autotune_results],
            outs = [name + "_" + target],
            cmd = (
                ...
                " --platform=gpu" +
                " --gpu_target_config=$(location " + target_configs[target] + ")" +
