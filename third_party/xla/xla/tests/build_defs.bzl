...
load("//xla/tsl/platform/default:cuda_build_defs.bzl", "if_cuda_is_configured", "is_cuda_configured")
...
def xla_py_test(name, deps = None, data = None, env = None, need_cuda_libs = False, **kwargs):
