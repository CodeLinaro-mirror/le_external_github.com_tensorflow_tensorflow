...
struct RecordContext
    : public internal::RecordContextBase<internal::ErrorConverter, Context> {
  using Base = internal::RecordContextBase<internal::ErrorConverter, Context>;
  using Base::Base;
  using ContextT = Context;
};

template <>
struct CtxDecoding<RecordContext> : public RecordContextDecoder<RecordContext> {
};
