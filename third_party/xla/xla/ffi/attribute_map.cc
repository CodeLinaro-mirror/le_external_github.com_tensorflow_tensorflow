...
using Attribute = xla::ffi::CallFrameBuilder::FlatAttribute;
using AttributesMap = xla::ffi::CallFrameBuilder::FlatAttributesMap;

absl::StatusOr<AttributesMap> xla::ffi::BuildAttributesMap(
