...
class MatMulEmitterHelper {
 ...
 private:
  ...
  absl::Status AddStandaloneDimToTensorParams(
      ...
      const TensorIterationSpec::DimIterationSpec* spec, ValueRange bases,
      TensorParams& tensor_params, std::vector<int32_t>& boundary_checks) {
  ...
  absl::Status AddDynamicSliceDimToTensorParams(
      ...
      const TensorIterationSpec::DimIterationSpec* spec, const ValueRange bases,
      TensorParams& tensor_params) {
