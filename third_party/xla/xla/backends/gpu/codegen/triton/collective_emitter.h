...
// See CreateTritonModule for an overview of how this fits into the emitter.
absl::StatusOr<triton::ScalarOrTensor> EmitCollective(
    ...
    absl::flat_hash_map<const TiledHloInstruction*,
                        triton::ScalarOrTensor::TensorValue>& values);
