...
absl::Status Autotune(HloModule& module, const std::string& autotune_cache_dir,
  ...
  const absl::flat_hash_map<std::string, AutotuneConfig::AutotuneCacheMode>
      mode_map = {
          {"READ", AutotuneConfig::AutotuneCacheMode::READ},
          {"WRITE", AutotuneConfig::AutotuneCacheMode::WRITE},
          {"READ_WRITE", AutotuneConfig::AutotuneCacheMode::READ_WRITE},
      };
