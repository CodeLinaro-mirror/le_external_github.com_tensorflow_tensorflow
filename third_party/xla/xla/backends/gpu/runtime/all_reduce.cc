...
absl::StatusOr<CollectiveKernelSpec> CreateAllReduceKernelSpec(
  ...
  CollectiveKernelSpec kernel_spec = {
      /* .io_buffers= */ {
          {/*requires_multimem=*/false, SymmetricMemoryType::kXlaRendezvous}},
      /* .scratch_buffers= */
      {{remote_size, /*requires_multimem=*/false, SymmetricMemoryType::kNone,
        /*should_memzero=*/false,
        /*should_double_buffer=*/true},
       {signal_size, /*requires_multimem=*/false, SymmetricMemoryType::kNone,
        /*should_memzero=*/true,
        /*should_double_buffer=*/true}},
