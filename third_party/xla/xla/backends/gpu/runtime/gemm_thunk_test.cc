...
TEST(GemmThunkTest, ProtoRoundTrip) {
  ...
  buffer_allocations.emplace_back(/*index=*/0, /*size=*/100, /*color=*/0);
  buffer_allocations.emplace_back(/*index=*/1, /*size=*/200, /*color=*/0);
  buffer_allocations.emplace_back(/*index=*/2, /*size=*/150, /*color=*/0);
  buffer_allocations.emplace_back(/*index=*/3, /*size=*/2048, /*color=*/0);
