...
class CublasBackendTest : public HloRunnerAgnosticTestBase {
 ...
 protected:
  ...
  CublasBackend backend_{&target_config_, &debug_options_, &compiler_};
};
...
TEST_F(CublasBackendTest, GetSupportedConfigsFromACublasCustomCall) {
...
TEST_F(CublasBackendTest, GetSupportedConfigsFromADot) {
  TF_ASSERT_OK_AND_ASSIGN(std::unique_ptr<HloModule> module,
...
TEST_F(CublasBackendTest, GetSupportedConfigsFromAFusionContainingAGemm) {
  TF_ASSERT_OK_AND_ASSIGN(std::unique_ptr<HloModule> module,
...
TEST_F(CublasBackendTest, GetDefaultConfigFromACublasCustomCall) {
  TF_ASSERT_OK_AND_ASSIGN(std::unique_ptr<HloModule> module,
                          ParseAndReturnVerifiedModule(kCublasCustomCallHlo));
...
TEST_F(CublasBackendTest, GetDefaultConfigFromADot) {
  TF_ASSERT_OK_AND_ASSIGN(std::unique_ptr<HloModule> module,
                          ParseAndReturnVerifiedModule(kDotHlo));
...
TEST_F(CublasBackendTest, GetDefaultConfigFromAFusionContainingAGemm) {
  TF_ASSERT_OK_AND_ASSIGN(std::unique_ptr<HloModule> module,
                          ParseAndReturnVerifiedModule(kFusionHlo));
...
TEST_F(CublasBackendTest, CompileACublasCustomCall) {
  TF_ASSERT_OK_AND_ASSIGN(std::unique_ptr<HloModule> module,
                          ParseAndReturnVerifiedModule(kCublasCustomCallHlo));
...
TEST_F(CublasBackendTest, CompileADot) {
  TF_ASSERT_OK_AND_ASSIGN(std::unique_ptr<HloModule> module,
                          ParseAndReturnVerifiedModule(kDotHlo));
  auto config = backend_.GetDefaultConfig(
      (*module->entry_computation()->root_instruction()));
...
TEST_F(CublasBackendTest, CompileAFusionContainingAGemm) {
  TF_ASSERT_OK_AND_ASSIGN(std::unique_ptr<HloModule> module,
                          ParseAndReturnVerifiedModule(kFusionHlo));
  auto config = backend_.GetDefaultConfig(
      (*module->entry_computation()->root_instruction()));
