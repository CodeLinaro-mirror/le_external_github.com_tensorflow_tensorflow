...
TEST_P(SortThunkTest, DynamicSort1D) {
  ...
  BufferAllocation alloc0(0, data_size_in_bytes, 0);
  BufferAllocation alloc1(1, ind_size_in_bytes, 0);
  BufferAllocation rest(2, empty_size_in_bytes, 0);

  BufferAllocation::Slice slice0(&alloc0, 0, data_size_in_bytes);
  BufferAllocation::Slice slice1(&alloc1, 0, ind_size_in_bytes);
