...
void MakeDebugOptionsFlags(std::vector<tsl::Flag>* flag_list,
  ...
  flag_list->push_back(tsl::Flag(
      ...
      "[Stable] Whether to enable XLA address computation fusion"));
  flag_list->push_back(tsl::Flag(
  ...
  flag_list->push_back(
      tsl::Flag("xla_gpu_enable_triton_gemm",
                ...
                "[Stable] Use Triton-based matrix multiplication."));
  flag_list->push_back(tsl::Flag(
  ...
  flag_list->push_back(tsl::Flag(
      ...
      "[Stable] Enable (slow) search for the Triton GEMM fusion tilings."));
  flag_list->push_back(tsl::Flag(
  ...
  flag_list->push_back(
      tsl::Flag("xla_gpu_cublas_fallback",
                ...
                "[Stable] Allow GEMM fusion autotuning to fall back to cuBLAS "
                "when that is faster."));
  flag_list->push_back(tsl::Flag(
