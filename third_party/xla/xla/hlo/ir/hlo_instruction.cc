...
/* static */ std::unique_ptr<HloInstruction> HloInstruction::CreateConvolve(
  ...
  HloConvolutionInstruction::ConvKind kind =
      HloConvolutionInstruction::ConvKind::UNSET;
  switch (conv_kind) {
    case CONVOLUTION_KIND_FPROP:
      kind = HloConvolutionInstruction::ConvKind::FPROP;
      break;
    case CONVOLUTION_KIND_WGRAD:
      kind = HloConvolutionInstruction::ConvKind::WGRAD;
      break;
    case CONVOLUTION_KIND_DGRAD:
      kind = HloConvolutionInstruction::ConvKind::DGRAD;
      break;
    default:
      break;
  }
  return std::make_unique<HloConvolutionInstruction>(
      ...
      dimension_numbers, precision_config, sparsity_config, kind);
}
