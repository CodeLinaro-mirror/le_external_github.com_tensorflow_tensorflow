...
PJRT_Error* PJRT_Layouts_PJRT_Executable_OutputLayouts(
    PJRT_Layouts_PJRT_Executable_OutputLayouts_Args* args) {
  PJRT_RETURN_IF_ERROR(ActualStructSizeIsGreaterOrEqual(
      "PJRT_Layouts_PJRT_Executable_OutputLayouts_Args",
      PJRT_Layouts_PJRT_Executable_OutputLayouts_Args_STRUCT_SIZE,
      args->struct_size));
  PJRT_RETURN_IF_ERROR(
