...
struct PJRT_Layouts_PJRT_Executable_OutputLayouts_Args {
  size_t struct_size;
  PJRT_Extension_Base* extension_start;
...
PJRT_DEFINE_STRUCT_TRAITS(PJRT_Layouts_PJRT_Executable_OutputLayouts_Args,
                          layouts);

// Returns a list of layouts for executable outputs. Each output has a layout.
typedef PJRT_Error* PJRT_Layouts_PJRT_Executable_OutputLayouts(
    PJRT_Layouts_PJRT_Executable_OutputLayouts_Args* args);
...
typedef struct PJRT_Layouts_Extension {
  ...
  PJRT_Layouts_PJRT_Topology_GetDefaultLayout*
      PJRT_Layouts_PJRT_Topology_GetDefaultLayout;
  PJRT_Layouts_PJRT_Executable_OutputLayouts*
      PJRT_Layouts_PJRT_Executable_OutputLayouts;
