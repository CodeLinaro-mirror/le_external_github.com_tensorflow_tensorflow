...
class PhaseCompileExtensionTest : public ::testing::Test {
 protected:
  ...
  PhaseCompileExtensionTest() {
    auto phase_compile_extension_or = xla::GetCApiPhaseCompiler("sample-cpu");
    CHECK_OK(phase_compile_extension_or);
    phase_compile_extension_wrapper_ = std::move(*phase_compile_extension_or);
