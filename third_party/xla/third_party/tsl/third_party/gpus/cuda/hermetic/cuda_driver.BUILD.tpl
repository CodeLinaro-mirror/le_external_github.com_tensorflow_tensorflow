...
genrule(
    ...
    outs = ["libcuda.cc"],
    cmd = "echo 'int fake_libcuda() { return 0; }' > $@",
)
...
cc_library(
    name = "nvidia_driver",
    %{comment}deps = [
        %{comment}":driver_libcuda_so_symlink",
        %{comment}":fake_libcuda",
        %{comment}":driver_libcuda_so_1_symlink",
